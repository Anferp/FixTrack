<template>
  <div class="search-filter">
    <div class="filter-header">
      <h3 class="filter-title">Filtrar Usuarios</h3>
    ...
    <div class="filter-form">
      <div class="filter-row">
        ...
        <div class="filter-group">
          ...
          <select id="role" v-model="filters.role" @change="updateFilters">
        ...
        <div class="filter-group">
          ...
          <select id="active" v-model="filters.active" @change="updateFilters">
            <option value="">Todos</option>
